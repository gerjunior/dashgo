      ...
      <Flex align="center" ml="auto">
        ...
        <Flex align="center">
          <Box mr="4" textAlign="right">
            <Text>Geraldo Júnior</Text>
            <Text color="gray.300" fontSize="small">geraldojuni@hotmail.com</Text>
          </Box>

          <Avatar size="md" name="Geraldo Júnior" src="https://github.com/gerjunior.png" />
        </Flex>
      </Flex>
    </Flex>
  )
